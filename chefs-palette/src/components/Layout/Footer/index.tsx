      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        ...
        <div className="border-t border-grey/15 dark:border-white/15 py-10 flex justify-between items-center">
          <p className="text-sm text-black/70 dark:text-white/70">
            @2024 - Chef's Palette. Distributed By <Link href="#" target="_blank" className="hover:text-primary">Sonalika Surbhi</Link> and Developed by <Link href="#" className="hover:text-primary">Sonalika Surbhi</Link>
          </p>
